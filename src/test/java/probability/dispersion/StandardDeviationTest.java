...
public class StandardDeviationTest {
	...
	@DisplayName("Deve calcular o desvio padrão")
	void standardDeviationTest1(BigDecimal[] in, BigDecimal expected) {
		BigDecimal actual = StandardDeviation.standardDeviation(in);
	...
	void standardDeviationTest2() {
		BigDecimal[] in = new BigDecimal[]{};

		assertThrows(ArithmeticException.class, () -> StandardDeviation.standardDeviation(in));
	}
